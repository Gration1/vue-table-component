<template>
    <div class="table-component">
        ...
        <div class="table-component__table-wrapper">
            <table :class="fullTableClass">
                ...
                <tbody :class="fullTableBodyClass">
                    <table-row v-for="row in displayedRows" :key="row.vueTableComponentInternalRowId" :row="row" :columns="columns" @rowClick="emitRowClick"></table-row>
                </tbody>
                <tfoot>
        ...
        <pagination v-if="pagination" :pagination="pagination" @pageChange="pageChange" :pagination-ul-class="paginationUlClass" :pagination-li-first-class="paginationLiFirstClass" :pagination-li-last-class="paginationLiLastClass" :pagination-li-ellipsis-class="paginationLiEllipsisClass" :pagination-li-prev-class="paginationLiPrevClass" :pagination-li-next-class="paginationLiNextClass" :pagination-li-page-class="paginationLiPageClass" >
            <template v-slot:tpagination="{pageClicked, pagination, hasFirst, hasFirstEllipsis, hasLast, hasLastEllipsis, isActive}">
                <slot name="tpagination" :pageClicked="pageClicked" :pagination="pagination" :hasFirst="hasFirst" :hasFirstEllipsis="hasFirstEllipsis" :hasLastEllipsis="hasLastEllipsis" :hasLast="hasLast" :isActive="isActive"></slot>
            </template>
            <template v-slot:pprev="{pageClicked, pagination}">
                <slot name="pprev" :pageClicked="pageClicked" :pagination="pagination"></slot>
            </template>
            <template v-slot:pnext="{pageClicked, pagination}">
                <slot name="pnext" :pageClicked="pageClicked" :pagination="pagination"></slot>
            </template>
            <template v-slot:pellipsis>
                <slot name="pellipsis"></slot>
            </template>
            <template v-slot:ppage="{pageClicked, page}">
                <slot name="ppage" :pageClicked="pageClicked" :page="page"></slot>
            </template>
            <template v-slot:pfirst="{pageClicked}">
                <slot name="pfirst" :pageClicked="pageClicked"></slot>
            </template>
            <template v-slot:plast="{pageClicked, pagination}">
                <slot name="plast" :pageClicked="pageClicked" :pagination="pagination"></slot>
            </template>
        </pagination>
    </div>
</template>
...
export default {
    ...
    props: {
        ...
        paginationUlClass: String,
        paginationLiFirstClass: String,
        paginationLiLastClass: String,
        paginationLiEllipsisClass: String,
        paginationLiPrevClass: String,
        paginationLiNextClass: String,
        paginationLiPageClass: String,
    },
